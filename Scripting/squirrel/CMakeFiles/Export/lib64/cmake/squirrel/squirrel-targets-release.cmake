...
set_target_properties(squirrel::squirrel PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsquirrel.so.0.0.0"
  IMPORTED_SONAME_RELEASE "libsquirrel.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS squirrel::squirrel )
list(APPEND _IMPORT_CHECK_FILES_FOR_squirrel::squirrel "${_IMPORT_PREFIX}/lib64/libsquirrel.so.0.0.0" )
...
set_target_properties(squirrel::squirrel_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsquirrel_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS squirrel::squirrel_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_squirrel::squirrel_static "${_IMPORT_PREFIX}/lib64/libsquirrel_static.a" )
...
set_target_properties(squirrel::sqstdlib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsqstdlib.so.0.0.0"
  IMPORTED_SONAME_RELEASE "libsqstdlib.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS squirrel::sqstdlib )
list(APPEND _IMPORT_CHECK_FILES_FOR_squirrel::sqstdlib "${_IMPORT_PREFIX}/lib64/libsqstdlib.so.0.0.0" )
...
set_target_properties(squirrel::sqstdlib_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsqstdlib_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS squirrel::sqstdlib_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_squirrel::sqstdlib_static "${_IMPORT_PREFIX}/lib64/libsqstdlib_static.a" )
