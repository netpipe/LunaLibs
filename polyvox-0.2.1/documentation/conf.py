...
sys.path.append('/home/Dev/libs/csg-stuff/polyvox-0.2.1/documentation/_extensions')
...
templates_path = ['/home/Dev/libs/csg-stuff/polyvox-0.2.1/documentation/_templates']
...
html_static_path = ['/home/Dev/libs/csg-stuff/polyvox-0.2.1/documentation/_static']
...
doxylink = {
	'polyvox' : ('/home/Dev/libs/csg-stuff/polyvox-0.2.1/documentation/../library/PolyVox.tag', '../library/doc/html/') #Make this '../api/' for uploading
}
